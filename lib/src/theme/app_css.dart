import 'package:ex_trader/src/const/extensions/textstyle_extension.dart';
...
class AppCss {
  ...
  static TextStyle get poppinsExtraBold65 =>
      poppins.extraThickBold.size(FontSizes.f65);
  static TextStyle get poppinsExtraBold60 =>
      poppins.extraThickBold.size(FontSizes.f60);
  static TextStyle get poppinsExtraBold34 => poppins.black.size(FontSizes.f34);
  static TextStyle get poppinsExtraBold30 => poppins.black.size(FontSizes.f30);
  static TextStyle get poppinsExtraBold20 => poppins.black.size(FontSizes.f20);
  ...
  //Text Style poppins bold
  static TextStyle get poppinsExtraBold32 =>
      poppins.extraBold.size(FontSizes.f32);
  static TextStyle get poppinsExtraBold28 =>
      poppins.extraBold.size(FontSizes.f28);
  static TextStyle get poppinsExtraBold24 =>
      poppins.extraBold.size(FontSizes.f24);
  static TextStyle get poppinsExtraBold22 =>
      poppins.extraBold.size(FontSizes.f22);
  static TextStyle get poppinsExtraBold18 =>
      poppins.extraBold.size(FontSizes.f18);
  static TextStyle get poppinsExtraBold16 =>
      poppins.extraBold.size(FontSizes.f16);
  static TextStyle get poppinsExtraBold14 =>
      poppins.extraBold.size(FontSizes.f14);
  static TextStyle get poppinsExtraBold12 =>
  ...
  static TextStyle get poppinsBold30 => poppins.bold.size(FontSizes.f30);
  ...
  static TextStyle get poppinsSemiBold124 =>
      poppins.semiBold.size(FontSizes.f24);
  static TextStyle get poppinsSemiBold20 =>
      poppins.semiBold.size(FontSizes.f20);
  static TextStyle get poppinsSemiBold18 =>
      poppins.semiBold.size(FontSizes.f18);
  static TextStyle get poppinsSemiBold16 =>
      poppins.semiBold.size(FontSizes.f16);
  static TextStyle get poppinsSemiBold15 =>
      poppins.semiBold.size(FontSizes.f15);
  static TextStyle get poppinsSemiBold14 =>
      poppins.semiBold.size(FontSizes.f14);
  static TextStyle get poppinsSemiBold12 =>
      poppins.semiBold.size(FontSizes.f12);
  static TextStyle get poppinsSemiBold10 =>
  ...
  static TextStyle get poppinsRegular17 => poppins.regular.size(FontSizes.f17);
  static TextStyle get poppinsRegular16 => poppins.regular.size(FontSizes.f16);
  static TextStyle get poppinsRegular15 => poppins.regular.size(FontSizes.f15);
